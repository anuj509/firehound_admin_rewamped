    ...
    t(document).ready(function() {
        t(document).on("click.card", ".card", function(e) {
            ...
            if (n.find(".card-reveal").length) {
                ...
                o || a ? n.find(".card-reveal").velocity({
                    translateY: 0
                }, {
                    duration: 225,
                    queue: !1,
            ...
            this.each(function() {
                ...
                function o(e) {
                    ...
                    if (!g.is("body") && g[0].scrollHeight > g[0].clientHeight && (m = g[0].scrollTop), a + c.innerWidth() > t(window).width() ? d = "right" : a - c.innerWidth() + r.innerWidth() < 0 && (d = "left"), u + c.innerHeight() > n)
                        ...
                        "left" === d ? (h = s.gutter, p = r.position().left + h) : "right" === d && (p = r.position().left + r.outerWidth() - c.outerWidth() + (h = -s.gutter)), c.css({
                        position: "absolute",
...
dropdownSelectors.on({
    ...
    function(t, e, n, i) {
        ...
        q.prototype = {
            ...
            preventDefaults: function(t) {
                ...
                if (this.manager.session.prevented) e.preventDefault();
                    ...
                    if (!r || !a) return o || a && n & Lt || r && n & Ft ? this.preventSrc(e) : void 0
                }
            },
        ...
        easeInElastic: function(t, e, n, i, o) {
            ...
            if (r || (r = .3 * o), s < Math.abs(i)) {
                s = i;
                a = r / 4
            } else a = r / (2 * Math.PI) * Math.asin(i / s);
        ...
        var o = function() {
            ...
            return function(n, i) {
                ...
                o.url = n, o.options_default = {
                    ...
                    startTime: 0,
                    endTime: 0
                }, o.options = e({}, o.options_default, i), o.videoID = o.parseURL(n), o.videoID && (o.ID = t++, o.loadAPI(), o.init())
            }
        }();
        ...
        v.prototype.css = function(e, n) {
            ...
            if (t.image.width && t.image.height) {
                var e = t.image.$container.getBoundingClientRect(),
                    ...
                    p = 0,
                    f = 0;
                c && (u = l < 0 ? l * Math.max(i, r) : l * (i + r), l > 1 ? h = Math.abs(u - r) : l < 0 ? h = u / l + Math.abs(u) : h += Math.abs(r - i) * (1 - l), u /= 2), (d = h * a / s) < n && (h = (d = n) * s / a), c ? (p = o + (n - d) / 2, f = (r - h) / 2) : (p = (n - d) / 2, f = (i - h) / 2), "absolute" === t.image.position && (p -= o), t.parallaxScrollDistance = u, t.css(t.image.$item, {
                    width: d + "px",
                    height: h + "px",
                    marginLeft: p + "px",
                    marginTop: f + "px"
    ...
    function(t) {
        t.fn.sticky = function(e) {
            var n = {
                ...
                a = 0 < t(i.stopper).length || "number" == typeof i.stopper;
            return this.each(function() {
                function e() {
                    var e = p.scrollTop(),
                        s = h,
    ...
    function(t, e) {
        ...
        return function(t, e, n, i) {
            var o = {
                ...
                detectFeatures: function() {
                    ...
                    for (var l, c, u = ["transform", "perspective", "animationName"], d = ["", "webkit", "Moz", "ms", "O"], h = 0; 4 > h; h++) {
                        e = d[h];
                        for (var p = 0; 3 > p; p++) l = u[p], c = e + (e ? l.charAt(0).toUpperCase() + l.slice(1) : l), !n[l] && c in t && (n[l] = c);
            ...
            o.extend(r, i);
            var s, l, c, u, d, h, p, f, m, g, v, y, b, x, w, k, C, S, T, M, I, A, P, _, D, E, O, L, F, R, W, V, z, N, H, B, Y, j, $, X, q, U, Q, Z, G, K, J, tt, et, nt, it, ot, at, rt, st, lt, ct = {
                    x: 0,
                    y: 0
                },
                ut = {
                ...
                Kt = function() {
                    for (var t in Ut) Ut.hasOwnProperty(t) && Zt(t)
                },
                Jt = function(t, e, n, i, o, a, r) {
                    ...
                    var c = function() {
                        if (Ut[t]) {
                            if ((s = Mt() - l) >= i) return Zt(t), a(n), void(r && r());
                ...
                te = {
                    ...
                    init: function() {
                        if (!s && !l) {
                            var n;
                            a.framework = o, a.template = t, a.bg = o.getChildByClass(t, "pswp__bg"), O = t.className, s = !0, W = o.detectFeatures(), D = W.raf, E = W.caf, A = W.transform, F = W.oldIE, a.scrollWrap = o.getChildByClass(t, "pswp__scroll-wrap"), a.container = o.getChildByClass(a.scrollWrap, "pswp__container"), d = a.container.style, a.itemHolders = k = [{
                                ...
                                wrap: 0,
                                index: -1
                            }], k[0].el.style.display = k[2].el.style.display = "none", jt(), m = {
                                resize: a.updateSize,
                                scroll: qt,
                                keydown: $t,
                                click: Xt
                            ...
                            for (W.animationName && W.transform && !i || (r.showAnimationDuration = r.hideAnimationDuration = 0), n = 0; n < yt.length; n++) a["init" + yt[n]]();
                            ...
                            var c = "pswp--open ";
                            for (r.mainClass && (c += r.mainClass + " "), r.showHideOpacity && (c += "pswp--animate_opacity "), c += _ ? "pswp--touch" : "pswp--notouch", c += W.animationName ? " pswp--css_animation" : "", c += W.svg ? " pswp--svg" : "", o.addClass(t, c), a.updateSize(), h = -1, gt = null, n = 0; 3 > n; n++) Dt((n + h) * mt.x, k[n].el.style);
                    ...
                    updateCurrItem: function(t) {
                        if (0 !== gt) {
                            ...
                            if (!(t && 2 > n)) {
                                ...
                                for (var i = 0; n > i; i++) gt > 0 ? (e = k.shift(), k[2] = e, h++, Dt((h + 2) * mt.x, e.el.style), a.setContent(e, u - n + i + 1 + 1)) : (e = k.pop(), k.unshift(e), h--, Dt(h * mt.x, e.el.style), a.setContent(e, u + n - i - 1 - 1));
                                if (et && 1 === Math.abs(gt)) {
                                    var o = qe(C);
                    ...
                    updateSize: function(e) {
                        ...
                        if (ht.x = a.scrollWrap.clientWidth, ht.y = a.scrollWrap.clientHeight, qt(), mt.x = ht.x + Math.round(ht.x * r.spacing), mt.y = ht.y, Et(mt.x * pt), Tt("beforeResize"), void 0 !== h) {
                            for (var i, s, l, c = 0; 3 > c; c++) i = k[c], Dt((c + h) * mt.x, i.el.style), l = u + c - 1, r.loop && Ue() > 2 && (l = kt(l)), s = qe(l), s && (w || s.needsUpdate || !s.bounds) ? (a.cleanSlide(s), a.setContent(i, l), 1 === c && (a.currItem = s, a.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === i.index && l >= 0 && a.setContent(i, l), s && s.container && (en(s, ht), rn(s), _t(s));
                            w = !1
                        }
                ...
                Le = function(t) {
                    if (!("mousedown" === t.type && t.button > 0)) {
                        ...
                        if (!Y || "mousedown" !== t.type) {
                            ...
                            var n = Ee(t),
                                i = n.length;
                            Z = null, Kt(), j && 1 !== i || (j = ot = !0, o.bind(window, p, a), H = st = at = B = Q = q = $ = X = !1, it = null, Tt("firstTouchStart", n), Lt(ut, dt), ct.x = ct.y = 0, Lt(oe, n[0]), Lt(ae, oe), se.x = mt.x * pt, le = [{
                                x: oe.x,
                                y: oe.y
                            }], z = V = Mt(), Nt(g, !0), be(), xe()), !G && i > 1 && !nt && !Q && (v = g, X = !1, G = $ = !0, ct.y = ct.x = 0, Lt(ut, dt), Lt(ee, n[0]), Lt(ne, n[1]), Me(ee, ne, me), fe.x = Math.abs(me.x) - dt.x, fe.y = Math.abs(me.y) - dt.y, K = J = ye(ee, ne))
                        }
                    }
                },
                Fe = function(t) {
                    ...
                    if (Z) {
                        ...
                        if (0 !== t)
                            if (Lt(ee, Z[0]), ie.x = ee.x - oe.x, ie.y = ee.y - oe.y, G && t > 1) {
                                if (oe.x = ee.x, oe.y = ee.y, !ie.x && !ie.y && ge(Z[1], ne)) return;
                                ...
                                if (!it) return;
                                if (ot && (ot = !1, Math.abs(ie.x) >= 10 && (ie.x -= Z[0].x - ae.x), Math.abs(ie.y) >= 10 && (ie.y -= Z[0].y - ae.y)), oe.x = ee.x, oe.y = ee.y, 0 === ie.x && 0 === ie.y) return;
                ...
                We = function(t) {
                    ...
                    if (P) {
                        ...
                        if (n > -1)
                            if (e = re.splice(n, 1)[0], navigator.pointerEnabled) e.type = t.pointerType || "mouse";
                            else {
                                var i = {
                                    4: "mouse",
                                    2: "touch",
                    ...
                    1 === c && Lt(ae, l[0]), 0 !== c || it || nt || (e || ("mouseup" === t.type ? e = {
                        x: t.pageX,
                        y: t.pageY,
                        type: "mouse"
                    ...
                    if (0 === c && (j = !1, o.unbind(window, p, a), be(), G ? u = 0 : -1 !== he && (u = Mt() - he)), he = 1 === c ? Mt() : -1, s = -1 !== u && 150 > u ? "zoom" : "swipe", G && 2 > c && (G = !1, 1 === c && (s = "zoomPointerUp"), Tt("zoomGestureEnded")), Z = null, q || X || nt || B)
                        if (Kt(), N || (N = Ve()), N.calculateSwipeSpeed("x"), B)
                            if (Ae() < r.verticalDragRange) a.close();
                            else {
                                var d = dt.y,
                                    h = rt;
                        ...
                        if (!nt) return "swipe" !== s ? void Be() : void(!Q && g > a.currItem.fitRatio && ze(N))
                    }
                },
                Ve = function() {
                    var t, e, n = {
            ...
            var Ye, je, $e, Xe, qe, Ue, Qe, Ze = function(e, n, i, s) {
                    ...
                    if (!d || !l || void 0 === l.x) return Tt("initialZoom" + (i ? "Out" : "In")), g = e.initialZoomLevel, Lt(dt, e.initialPosition), Pt(), t.style.opacity = i ? 0 : 1, It(1), void(d ? setTimeout(function() {
                        h()
                    }, d) : h());
                    ! function() {
                        var n = c,
                        ...
                        e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), i || (g = l.w / e.w, dt.x = l.x, dt.y = l.y - L, a[s ? "template" : "bg"].style.opacity = .001, Pt()), Gt("initialZoom"), i && !n && o.removeClass(t, "pswp--animated-in"), s && (i ? o[(n ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function() {
                            ...
                            } else g = e.initialZoomLevel, Lt(dt, e.initialPosition), Pt(), It(1), s ? t.style.opacity = 1 : It(1), Ye = setTimeout(h, d + 20)
                        }, i ? 25 : 90)
                    }()
                },
                Ge = {},
                ...
                en = function(t, e, n) {
                    if (t.src && !t.loadError) {
                        ...
                        if (i && (t.vGap || (t.vGap = {
                                top: 0,
                                bottom: 0
                            }), Tt("parseVerticalMargin", t)), Ge.x = e.x, Ge.y = e.y - t.vGap.top - t.vGap.bottom, i) {
                            var o = Ge.x / t.w,
                                a = Ge.y / t.h;
                            t.fitRatio = a > o ? o : a;
                            var s = r.scaleMode;
                ...
                sn = function() {
                    if (Ke.length) {
                        for (var t, e = 0; e < Ke.length; e++)(t = Ke[e]).holder.index === t.index && nn(t.index, t.item, t.baseDiv, t.img, 0, t.clearPlaceholder);
                        Ke = []
                    }
                };
            wt("Controller", {
                publicMethods: {
                    ...
                    setContent: function(t, e) {
                        ...
                        if (l) {
                            ...
                            if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), an(l), en(l, ht), !l.src || l.loadError || l.loaded) l.src && !l.loadError && (i = o.createEl("pswp__img", "img"), i.style.opacity = 1, i.src = l.src, rn(l, i), nn(0, l, c, i));
                            else {
                                if (l.loadComplete = function(n) {
                                        if (s) {
                                            if (t && t.index === e) {
                                                if (an(n, !0)) return n.loadComplete = n.img = null, en(n, ht), _t(n), void(t.index === u && a.updateCurrZoomItem());
                                                n.imageAppended ? !Xe && n.placeholder && (n.placeholder.style.display = "none", n.placeholder = null) : W.transform && (nt || Xe) ? Ke.push({
                                                    item: n,
                                                    baseDiv: c,
                                                    img: n.img,
                                                    index: e,
                                ...
                                l.loading || on(l), a.allowProgressiveImg() && (!$e && W.transform ? Ke.push({
                                    item: l,
                                    baseDiv: c,
                                    img: l.img,
                                    index: e,
            ...
            wt("Tap", {
                publicMethods: {
                    ...
                    onTapRelease: function(t, e) {
                        if (e && !q && !$ && !Qt) {
                            var n = e;
                            if (ln && (clearTimeout(ln), ln = null, ve(n, cn))) return void Tt("doubleTap", n);
                            if ("mouse" === e.type) return void un(t, e, "mouse");
                            if ("BUTTON" === t.target.tagName.toUpperCase() || o.hasClass(t.target, "pswp__single-tap")) return void un(t, e);
            ...
            wt("DesktopZoom", {
                publicMethods: {
                    ...
                    handleMouseWheel: function(t) {
                        if (g <= a.currItem.fitRatio) return r.modal && (!r.closeOnScroll || Qt || j ? t.preventDefault() : A && Math.abs(t.deltaY) > 2 && (c = !0, a.close())), !0;
                        if (t.stopPropagation(), dn.x = 0, "deltaX" in t) 1 === t.deltaMode ? (dn.x = 18 * t.deltaX, dn.y = 18 * t.deltaY) : (dn.x = t.deltaX, dn.y = t.deltaY);
                        else if ("wheelDelta" in t) t.wheelDeltaX && (dn.x = -.16 * t.wheelDeltaX), t.wheelDeltaY ? dn.y = -.16 * t.wheelDeltaY : dn.y = -.16 * t.wheelDelta;
                        else {
            ...
            var hn, pn, fn, mn, gn, vn, yn, bn, xn, wn, kn, Cn, Sn = {
                    history: !0,
                    galleryUID: 1
                },
                Tn = function() {
        ...
        return function(t, e) {
            var n, i, o, a, r, s, l, c, u, d, h, p, f, m, g, v, y, b, x, w = this,
                ...
                M = function(t) {
                    ...
                    for (var n, i, o = (t.target || t.srcElement).getAttribute("class") || "", a = 0; a < j.length; a++)(n = j[a]).onTap && o.indexOf("pswp__" + n.name) > -1 && (n.onTap(), i = !0);
                    if (i) {
...
var initPhotoSwipeFromDOM = function(t) {
    for (var e = function(t) {
            for (var e, n, i, o, a = t.childNodes, r = a.length, s = [], l = 0; l < r; l++) 1 === (e = a[l]).nodeType && (i = (n = e.children[0]).getAttribute("data-size").split("x"), o = {
        ...
        }, o = document.querySelectorAll(t), a = 0, r = o.length; a < r; a++) o[a].setAttribute("data-pswp-uid", a + 1), o[a].onclick = function(t) {
...
initPhotoSwipeFromDOM(".mdb-lightbox"),
            ...
            t(this).each(function() {
                ...
                if (!i.hasClass("browser-default")) {
                    ...
                    if (l && (i.parent().find("span.caret").remove(), i.parent().find("input").remove(), i.unwrap(), t("ul#select-options-" + l).remove()), "destroy" !== e) {
                        ...
                        var d = t('<ul id="select-options-' + c + '" class="dropdown-content select-dropdown ' + (a ? "multiple-select-dropdown" : "") + '"></ul>'),
                        ...
                        h.length && h.each(function() {
                            if (t(this).is("option")) a ? y(i, t(this), "multiple") : y(i, t(this));
                        ...
                        var x = m.replace(/"/g, "&quot;"),
                            w = t('<input type="text" class="select-dropdown" readonly="true" ' + (i.is(":disabled") ? "disabled" : "") + ' data-activates="select-options-' + c + '" value="' + x + '"/>');
                        i.before(w), w.before(b), w.after(d), i.is(":disabled") || w.dropdown({
                            hover: !1,
                            closeOnClick: !1
                        }), i.attr("tabindex") && t(w[0]).attr("tabindex", i.attr("tabindex")), i.addClass("initialized"), w.on({
                            focus: function() {
    ...
    function(t) {
        ...
        n.prototype.set = function(t, e, n) {
            ...
            var o, a, r, s, l = e.isArray(n),
                ...
                u = this.item.view;
            if (l || c) {
                for (c ? (a = n.year, r = n.month, s = n.date) : (a = +n[0], r = +n[1], s = +n[2]), i && i.nav && u && u.month !== r && (a = u.year, r = u.month), a = (o = new Date(a, r + (i && i.nav ? i.nav : 0), 1)).getFullYear(), r = o.getMonth(); new Date(a, r, s).getMonth() !== r;) s -= 1;
                n = [a, r, s]
            }
            return n
    ...
    function() {
        ...
        function i(i, r) {
            ...
            if (r.twelvehour)
                for (D = 1; D < 13; D += 1) E = F.clone(), O = D / 6 * Math.PI, L = y, E.css("font-size", "140%"), E.css({
                    left: v + Math.sin(O) * L - x,
                    top: v - Math.cos(O) * L - x
                }), E.html(0 === D ? "00" : D), g.append(E), E.on(h, l);
            else
                for (D = 0; D < 24; D += 1) {
                    ...
                    L = R ? b : y, E.css({
                        left: v + Math.sin(O) * L - x,
                        top: v - Math.cos(O) * L - x
                    }), R && E.css("font-size", "120%"), E.html(0 === D ? "00" : D), g.append(E), E.on(h, l)
                }
            for (D = 0; D < 60; D += 5) E = F.clone(), O = D / 30 * Math.PI, E.css({
                left: v + Math.sin(O) * y - x,
                top: v - Math.cos(O) * y - x
            }), E.css("font-size", "140%"), E.html(e(D)), S.append(E), E.on(h, l);
...
! function(t) {
        ...
        i = function() {
            function i(o, a) {
                ...
                t("body").append(d), "left" == a.edge ? (this.menu_id.css("transform", "translateX(-100%)"), d.css({
                    ...
                    if (e.preventDefault(), !0 === s) s = !1, r.removeMenu();
                    else {
                        var n = t("body"),
    ...
    t.fn.sideNav = function(e) {
        ...
        }, 700), void 0 !== i && !1 !== i && history.replaceState(null, null, e)
            ...
            n.isWindow = function(t) {
                ...
                if (i) {
                    if (r)
                        ...
                        for (o in t)
                            if (!1 === n.apply(t[o], i)) break
                } else if (r)
                    for (; a > o && !1 !== n.call(t[o], o, t[o]); o++);
                else
                    for (o in t)
                        if (!1 === n.call(t[o], o, t[o])) break; return t
                                    ...
                                    for (var I in k)
                                        if ("element" !== I) {
                                            ...
                                            if (1 === v) A = P.endValue;
                                                ...
                                                if (A = P.startValue + D * _(v, c, D), !f && A === P.currentValue) continue
                                            }
                    ...
                    var w = b.CSS = {
                        ...
                        Normalizations: {
                            ...
                            register: function() {
                                ...
                                for (t = 0; t < w.Lists.transformsBase.length; t++) ! function() {
                    ...
                    var k = function() {
                                    ...
                                    for (var L in g) {
                                        ...
                                        if (r(a).isSVG || "tween" === z || !1 !== w.Names.prefixCheck(z)[1] || w.Normalizations.registered[z] !== i) {
                                            ...
                                            if (H = p(L, V), V = H[0], Y = H[1], H = p(L, R), R = H[0].replace(/^([+-\/*])=/, function(t, e) {
                                                    return j = e, ""
                                                }), B = H[1], V = parseFloat(V) || 0, R = parseFloat(R) || 0, "%" === B && (/^(fontSize|lineHeight)$/.test(L) ? (R /= 100, B = "em") : /^scale/.test(L) ? (R /= 100, B = "") : /(Red|Green|Blue)$/i.test(L) && (R = R / 100 * 255, B = "")), /[\/*]/.test(j)) B = Y;
                                            else if (Y !== B && 0 !== V)
                                                if (0 === R) B = Y;
                                                else {
                                                    o = o || function() {
                                                        var t = {
                                                            ...
                                                            i = t.position === E.lastPosition && t.myParent === E.lastParent,
                                                            o = t.fontSize === E.lastFontSize;
                                                        E.lastParent = t.myParent, E.lastPosition = t.position, E.lastFontSize = t.fontSize;
                                                        var s = 100,
                                                            l = {};
                                                        if (o && i) l.emToPx = E.lastEmToPx, l.percentToPxWidth = E.lastPercentToPxWidth, l.percentToPxHeight = E.lastPercentToPxHeight;
                                                        else {
                                            ...
                                            l[L] = {
                                                ...
                                                unitType: B,
                                                easing: W
                                            }, b.debug && console.log("tweensContainer (" + L + "): " + JSON.stringify(l[L]), a)
                        ...
                        if (m.isWrapped(this) ? (s = !1, p = 0, f = this, l = this) : (s = !0, p = 1, f = x ? arguments[0].elements || arguments[0].e : arguments[0]), f = a(f)) {
                            ...
                            if (!/^(stop|finish)$/i.test(g) && !h.isPlainObject(y)) {
                                y = {};
                                for (var T = p + 1; T < arguments.length; T++) m.isArray(arguments[T]) || !/^(fast|normal|slow)$/i.test(arguments[T]) && !/^\d/.test(arguments[T]) ? m.isString(arguments[T]) || m.isArray(arguments[T]) ? y.easing = arguments[T] : m.isFunction(arguments[T]) && (y.complete = arguments[T]) : y.duration = arguments[T]
                            }
                            var M = {
                                promise: null,
                                resolver: null,
    ...
    function(t, e) {
        ...
        function l(t) {
            if (!1 === g.allowEvent(t)) return null;
        ...
        var u = u || {},
            ...
            f = {
                ...
                hide: function(t, e) {
                    for (var n = (e = e || this).getElementsByClassName("waves-rippling"), i = 0, o = n.length; i < o; i++) s(t, e, n[i])
                }
            },
            m = {
                input: function(t) {
        ...
        return u.init = function(t) {
            ...
            for (var n, i, a = 0, r = t.length; a < r; a++) i = (n = t[a]).tagName.toLowerCase(), -1 !== ["input", "img"].indexOf(i) && (m[i](n), n = n.parentElement), -1 === n.className.indexOf("waves-effect") && (n.className += " waves-effect" + e)
            ...
            for (var e = {
                    type: "mouseup",
                    button: 1
                }, n = 0, i = (t = o(t)).length; n < i; n++) f.hide(e, t[n])
...
WOW.prototype._initStorageVariables = function() {
        ...
        t.style.animationPlayState || t.style.WebkitAnimationPlayState; - 1 === t.className.indexOf(this._animateClass) && (delete this._boxes[e], this._onStartAnimation(t, e), this._onStopAnimation(t, e), this._animate(t, e, this._getAnimationConfig(t)))
        ...
        var e = t.className.split(" "),
            n = e.indexOf(this._animateClass); - 1 !== n && (e.splice(n, 1), t.className = e.join(" "))
    }, WOW.prototype._eachBox = function(t) {
        for (var e = 0; e < this._boxes.length; e++) this._boxes[e] && function(e) {
            t(this._boxes[e], e)
        }.bind(this)(e)
        ...
        return function t(e, n, i) {
            ...
            2: [function(t, e, n) {
                function i(t) {
                    if (t) {
                        ...
                        if (l) {
                            l = l[1];
                            for (u = 0; u < r.length; u++) r[u] = parseInt(l[u] + l[u], 16)
                        } else if (l = t.match(n)) {
                            l = l[1];
                            for (u = 0; u < r.length; u++) r[u] = parseInt(l.slice(2 * u, 2 * u + 2), 16)
                        } else if (l = t.match(i)) {
                            for (u = 0; u < r.length; u++) r[u] = parseInt(l[u + 1]);
                            s = parseFloat(l[4])
                        } else if (l = t.match(o)) {
                            for (u = 0; u < r.length; u++) r[u] = Math.round(2.55 * parseFloat(l[u + 1]));
                            s = parseFloat(l[4])
                        } else if (l = t.match(a)) {
                            if ("transparent" == l[1]) return [0, 0, 0, 0];
                            if (!(r = d[l[1]])) return
                        }
                        for (var u = 0; u < r.length; u++) r[u] = c(r[u], 0, 255);
                ...
                a.prototype = {
                    ...
                    clone: function() {
                        var t, e, n = new a,
                            i = this.values,
                            o = n.values;
                        for (var r in i) i.hasOwnProperty(r) && (t = i[r], "[object Array]" === (e = {}.toString.call(t)) ? o[r] = t.slice(0) : "[object Number]" === e ? o[r] = t : console.error("unexpected color value:", t));
                        return n
                    }
                }, a.prototype.spaces = {
                    rgb: ["red", "green", "blue"],
            ...
            4: [function(t, e, n) {
                ...
                function d(t) {
                    ...
                    for (var c = 0; c < 3; c++)(i = r + 1 / 3 * -(c - 1)) < 0 && i++, i > 1 && i--, a = 6 * i < 1 ? e + 6 * (n - e) * i : 2 * i < 1 ? n : 3 * i < 2 ? e + (n - e) * (2 / 3 - i) * 6 : e, o[c] = 255 * a;
                    return o
                }
                ...
                e.exports = function(t) {
                    ...
                    t.defaults.bar = {
                        ...
                        getStackCount: function(t) {
                            var e, n, i = this,
                                o = i.chart,
                                a = i.getIndexScale().options.stacked,
                                r = void 0 === t ? o.data.datasets.length : t + 1,
                                s = [];
                            for (e = 0; e < r; ++e)(n = o.getDatasetMeta(e)).bar && o.isDatasetVisible(e) && (!1 === a || !0 === a && -1 === s.indexOf(n.stack) || void 0 === a && (void 0 === n.stack || -1 === s.indexOf(n.stack))) && s.push(n.stack);
                            return s.length
                        },
                        ...
                        getRuler: function() {
                            var t = this,
                                ...
                                i = n.options,
                                o = t.getStackCount(),
                                a = (n.isHorizontal() ? n.width : n.height) / n.ticks.length,
                        ...
                        calculateBarValuePixels: function(t, e) {
                            ...
                            if (f || void 0 === f && void 0 !== m)
                                for (n = 0; n < t; ++n)(i = c.getDatasetMeta(n)).bar && i.stack === m && i.controller.getValueScaleId() === d.id && c.isDatasetVisible(n) && (o = Number(h[n].data[e]), (p < 0 && o < 0 || p >= 0 && o > 0) && (g += o));
                    ...
                    n.doughnut = {
                        ...
                        legend: {
                            ...
                            onClick: function(t, e) {
                                var n, i, o, a = e.index,
                                    r = this.chart;
                                for (n = 0, i = (r.data.datasets || []).length; n < i; ++n)(o = r.getDatasetMeta(n)).data[a] && (o.data[a].hidden = !o.data[a].hidden);
                                r.update()
                            }
                        },
                        cutoutPercentage: 50,
                        ...
                        getMaxBorderWidth: function(t) {
                            for (var e, n, i = 0, o = this.index, a = t.length, r = 0; r < a; r++) e = t[r]._model ? t[r]._model.borderWidth : 0, i = (n = t[r]._chart ? t[r]._chart.config.data.datasets[o].hoverBorderWidth : 0) > (i = e > i ? e : i) ? n : i;
                            return i
                        }
                    })
                }
                    ...
                    t.defaults.line = {
                        ...
                        updateElement: function(t, e, i) {
                            var o, a, r = this,
                                ...
                                m = 1 === (r.chart.data.labels || []).length || 1 === c.data.length || r.chart.isCombo;
                            void 0 !== c.radius && void 0 === c.pointRadius && (c.pointRadius = c.radius), void 0 !== c.hitRadius && void 0 === c.pointHitRadius && (c.pointHitRadius = c.hitRadius), o = p.getPixelForValue("object" == typeof d ? d : NaN, e, u, m), a = i ? h.getBasePixel() : r.calculatePointY(d, e, u), t._xScale = p, t._yScale = h, t._datasetIndex = u, t._index = e, t._model = {
                                x: o,
                                y: a,
                        ...
                        updateBezierControlPoints: function() {
                            ...
                            if (s.dataset._model.spanGaps && (c = c.filter(function(t) {
                                ...
                                for (e = 0, i = c.length; e < i; ++e) o = c[e]._model, a = n.splineCurve(n.previousItem(c, e)._model, o, n.nextItem(c, e)._model, s.dataset._model.tension), o.controlPointPreviousX = a.previous.x, o.controlPointPreviousY = a.previous.y, o.controlPointNextX = a.next.x, o.controlPointNextY = a.next.y;
                            if (r.chart.options.elements.line.capBezierPoints)
                                for (e = 0, i = c.length; e < i; ++e)(o = c[e]._model).controlPointPreviousX = t(o.controlPointPreviousX, l.left, l.right), o.controlPointPreviousY = t(o.controlPointPreviousY, l.top, l.bottom), o.controlPointNextX = t(o.controlPointNextX, l.left, l.right), o.controlPointNextY = t(o.controlPointNextY, l.top, l.bottom)
                        },
                        draw: function() {
                            var n = this,
                                i = n.chart,
                    ...
                    t.defaults.polarArea = {
                        ...
                        legend: {
                            labels: {
                                generateLabels: function(t) {
                                    ...
                                    return n.labels.length && n.datasets.length ? n.labels.map(function(i, o) {
                                        ...
                                        return {
                                            text: i,
                                            fillStyle: s.backgroundColor ? s.backgroundColor : l(r.backgroundColor, o, c.backgroundColor),
                                            strokeStyle: s.borderColor ? s.borderColor : l(r.borderColor, o, c.borderColor),
                                            lineWidth: s.borderWidth ? s.borderWidth : l(r.borderWidth, o, c.borderWidth),
                                            hidden: isNaN(r.data[o]) || a.data[o].hidden,
                                            index: o
                                        }
                                    }) : []
                            ...
                            onClick: function(t, e) {
                                var n, i, o, a = e.index,
                                    r = this.chart;
                                for (n = 0, i = (r.data.datasets || []).length; n < i; ++n)(o = r.getDatasetMeta(n)).data[a].hidden = !o.data[a].hidden;
                                r.update()
                            }
                        },
                        tooltips: {
            ...
            21: [function(t, e, n) {
                ...
                e.exports = function(t) {
                    ...
                    t.defaults.global.animation = {
                        ...
                        advance: function(t) {
                            for (var n, i, o = this.animations, a = 0; a < o.length;) i = (n = o[a]).chart, n.currentStep = (n.currentStep || 0) + t, n.currentStep = Math.min(n.currentStep, n.numSteps), e.callback(n.render, [i, n], i), e.callback(n.onAnimationProgress, [n], i), n.currentStep >= n.numSteps ? (e.callback(n.onAnimationComplete, [n], i), i.animating = !1, o.splice(a, 1)) : ++a
                        }
            ...
            22: [function(t, e, n) {
                ...
                e.exports = function(t) {
                    ...
                    e.drawPoint = function(e, n, i, o, a) {
                        ...
                        } else e.drawImage(n, o - n.width / 2, a - n.height / 2, n.width, n.height)
                    }, e.clipArea = function(t, e) {
                        t.save(), t.beginPath(), t.rect(e.left, e.top, e.right - e.left, e.bottom - e.top), t.clip()
                    }, e.unclipArea = function(t) {
                        t.restore()
                    }, e.lineTo = function(t, e, n, i) {
                        if (n.steppedLine) return "after" === n.steppedLine ? t.lineTo(e.x, n.y) : t.lineTo(n.x, e.y), void t.lineTo(n.x, n.y);
                ...
                e.exports = function(t) {
                    ...
                    t.types = {}, t.instances = {}, t.controllers = {}, o.extend(t.prototype, {
                        ...
                        destroy: function() {
                            var e, n, i, s = this,
                                l = s.canvas;
                            for (s.stop(), n = 0, i = s.data.datasets.length; n < i; ++n)(e = s.getDatasetMeta(n)).controller && (e.controller.destroy(), e.controller = null);
            ...
            24: [function(t, e, n) {
                ...
                e.exports = function(t) {
                    ...
                    function n(t, e) {
                        ...
                        if (n) {
                            var i = n.listeners,
                                a = i.indexOf(e); - 1 !== a && i.splice(a, 1), i.length > 0 || (o.forEach(function(e) {
                                delete t[e]
                            }), delete t._chartjs)
                        }
                    }
            ...
            26: [function(t, e, n) {
                ...
                e.exports = function(t) {
                    ...
                    a.each = function(t, e, n, i) {
                        ...
                        for (var e = 1, n = arguments.length; e < n; e++) a.each(arguments[e], function(e, n) {
                            t[n] = e
                        });
                        return t
                        ...
                        var p;
                        for (e = 0; e < s; ++e)(i = r[e]).model.skip || (n = e > 0 ? r[e - 1] : null, o = e < s - 1 ? r[e + 1] : null, n && !n.model.skip && (p = (i.model.x - n.model.x) / 3, i.model.controlPointPreviousX = i.model.x - p, i.model.controlPointPreviousY = i.model.y - p * i.mK), o && !o.model.skip && (p = (o.model.x - i.model.x) / 3, i.model.controlPointNextX = i.model.x + p, i.model.controlPointNextY = i.model.y + p * i.mK))
            ...
            27: [function(t, e, n) {
                ...
                e.exports = function(t) {
                    ...
                    function a(t, n, a) {
                        var r = e(n, t),
                            s = a.intersect ? i(t, r) : o(t, r, !1, function(t, e) {
                        ...
                        update: function(t, o, a) {
                            ...
                            if (t) {
                                ...
                                var b = o - u - d,
                                    x = a - h - p,
                                    w = x / 2,
                                    k = (o - b / 2) / (f.length + m.length),
                                    C = (a - w) / (g.length + v.length),
                                    S = b,
                                    T = x,
                                    M = [];
                                i.each(f.concat(m, g, v), function(t) {
                                    var e, n = t.isHorizontal();
                                    n ? (e = t.update(t.fullWidth ? b : S, C), T -= e.height) : (e = t.update(k, w), S -= e.width), M.push({
                                        horizontal: n,
                                        minSize: e,
                                        box: t
                                    })
                                ...
                                var z = u + F,
                                    N = h + R;
                                i.each(f.concat(g), s), z += S, N += T, i.each(m, s), i.each(v, s), t.chartArea = {
                                    left: D,
                                    top: O,
                                    right: D + S,
                                    bottom: O + T
                    ...
                    t.defaults.global.plugins = {}, t.plugins = {
                        ...
                        notify: function(t, e, n) {
                            var i, o, a, r, s, l = this.descriptors(t),
                                c = l.length;
                            for (i = 0; i < c; ++i)
                                if (o = l[i], a = o.plugin, "function" == typeof(s = a[e]) && ((r = [t].concat(n || [])).push(o.options), !1 === s.apply(a, r))) return !1;
                            return !0
                        },
                        descriptors: function(n) {
                            ...
                            return this._plugins.concat(r.plugins || []).forEach(function(t) {
                                if (-1 === o.indexOf(t)) {
                                    var n = t.id,
                                        i = l[n];
                                    !1 !== i && (!0 === i && (i = e.clone(s[n])), o.push(t), a.push({
                                        plugin: t,
                                        options: i || {}
                                    }))
                                }
                                ...
                                if (i.each(o.ticks, function(t, n) {
                                        if (void 0 !== t && null !== t) {
                                            ...
                                            if ((!(r > 1 && n % r > 0 || n % r == 0 && n + r >= o.ticks.length) || s) && void 0 !== t && null !== t) {
                                                ...
                                                var v, b, x, k, C, P, _, D, E, O, L = "middle",
                                                    F = "middle";
                                                if (m) {
                                    ...
                                    var P, _, D = 0;
                                    if (m) P = o.left + (o.right - o.left) / 2, _ = "bottom" === a.position ? o.bottom - x.size / 2 : o.top + x.size / 2;
                                    else {
                    ...
                    t.defaults.global.tooltips = {
                        ...
                        getCaretPosition: function(t, e, n) {
                            var i, o, a, r, s, l, c = n.caretSize,
                                ...
                                m = e.width,
                                g = e.height;
                            if ("center" === h) s = f + g / 2, "left" === d ? (o = (i = p) - c, a = i, r = s + c, l = s - c) : (o = (i = p + m) + c, a = i, r = s - c, l = s + c);
                            else if ("left" === d ? (i = (o = p + u + c) - c, a = o + c) : "right" === d ? (i = (o = p + m - u - c) - c, a = o + c) : (i = (o = p + m / 2) - c, a = o + c), "top" === h) s = (r = f) - c, l = r;
                            else {
                                s = (r = f + g) + c, l = r;
                                var v = a;
                                a = i, i = v
                        ...
                        addEventListener: function(t, e, n) {
                            ...
                            if ("resize" !== e) {
                                var a = n._chartjs || (n._chartjs = {}),
                                    s = (a.proxies || (a.proxies = {}))[t.id + "_" + e] = function(e) {
                                        n(o(e, t))
                                    };
                                l.addEvent(i, e, s)
                            } else r(i.parentNode, n, t)
                        },
                ...
                e.exports = function(t) {
                    ...
                    function s(t, e, n, i, o, s) {
                        var l, c, u, d, h, p, f, m = e.length,
                            ...
                            b = 0,
                            x = 0;
                        for (t.beginPath(), l = 0, c = m + !!s; l < c; ++l) h = n(d = e[u = l % m]._view, u, i), p = a(d), f = a(h), p && f ? (b = v.push(d), x = y.push(h)) : b && x && (g ? (p && v.push(d), f && y.push(h)) : (r(t, v, y, b, x), b = x = 0, v = [], y = []));
                    ...
                    return {
                        ...
                        afterDatasetsUpdate: function(a, r) {
                            var s, l, c, u, d = (a.data.datasets || []).length,
                                h = r.propagate,
                                p = [];
                            for (l = 0; l < d; ++l) u = null, (c = (s = a.getDatasetMeta(l)).dataset) && c._model && c instanceof t.elements.Line && (u = {
                            ...
                            if (g ? (m.width = n.maxWidth, m.height = r ? 10 : 0) : (m.width = r ? 10 : 0, m.height = n.maxHeight), r)
                                if (s.font = p, g) {
                                    ...
                                    s.textAlign = "left", s.textBaseline = "top", i.each(n.legendItems, function(t, i) {
                                        ...
                                        v[v.length - 1] + o + a.padding >= n.width && (y += u + a.padding, v[v.length] = n.left), f[i] = {
                                            left: 0,
                                            top: 0,
                                            width: o,
                                            height: u
                                    ...
                                    i.each(n.legendItems, function(t, n) {
                                        ...
                                        C + S > m.height && (w += k + a.padding, x.push(k), k = 0, C = 0), k = Math.max(k, i), C += S, f[n] = {
                                            left: 0,
                                            top: 0,
                                            width: i,
                                            height: u
                                ...
                                if (void 0 === s && e.each(a, function(e, n) {
                                    ...
                                    e.each(a, function(a, r) {
                                        var s = o.getDatasetMeta(r),
                                            c = [s.type, void 0 === i.stacked && void 0 === s.stack ? r : "", s.stack].join(".");
                                        void 0 === l[c] && (l[c] = {
                                            positiveValues: [],
                                            negativeValues: []
                                        });
                    ...
                    t.LinearScaleBase = t.Scale.extend({
                        ...
                        buildTicks: function() {
                            var n = this,
                                ...
                                r = n.ticks = t.Ticks.generators.linear(a, n);
                        ...
                        i = t.Scale.extend({
                            ...
                            buildTicks: function() {
                                var n = this,
                                    ...
                                    a = n.ticks = t.Ticks.generators.logarithmic(o, n);
            ...
            49: [function(t, e, n) {
                ...
                i = "function" == typeof i ? i : window.moment, e.exports = function(t) {
                    ...
                    t.Ticks.generators.time = function(t, e) {
                        ...
                        return "week" === t.unit && !1 !== r ? (n = i(e.min).startOf("isoWeek").isoWeekday(r).valueOf(), o = i(e.max).startOf("isoWeek").isoWeekday(r), e.max - o > 0 && o.add(1, "week"), o = o.valueOf()) : (n = i(e.min).startOf(t.unit).valueOf(), o = i(e.max).startOf(t.unit), e.max - o > 0 && o.add(1, t.unit), o = o.valueOf()), a(t, e, {
                            min: n,
                            max: o
                        })
                    };
    ...
    function(t) {
        t(["jquery"], function(t) {
            return function() {
                ...
                function n(e) {
                    for (var n = u.children(), o = n.length - 1; o >= 0; o--) i(t(n[o]), e)
                }
                ...
                function s(n) {
                    ...
                    function m(e) {
                        if (!t(":focus", k).length || e) return clearTimeout(I.intervalId), k[b.hideMethod]({
                    ...
                    function v() {
                        clearTimeout(w), I.hideEta = 0, k.stop(!0, !0)[b.showMethod]({
                    ...
                    if (void 0 !== n.optionsOverride && (b = t.extend(b, n.optionsOverride), x = n.optionsOverride.iconClass || x), ! function(t, e) {
                        ...
                        return i(), a(), s(), d(), f(), o(), k.hide(), k[b.showMethod]({
                            ...
                            easing: b.showEasing,
                            complete: b.onShown
                        }), b.timeOut > 0 && (w = setTimeout(m, b.timeOut), I.maxHideTime = parseFloat(b.timeOut), I.hideEta = (new Date).getTime() + I.maxHideTime, b.progressBar && (I.intervalId = setInterval(y, 10))), k.hover(v, g), !b.onclick && b.tapToDismiss && k.click(m), b.closeButton && M && M.click(function(t) {
