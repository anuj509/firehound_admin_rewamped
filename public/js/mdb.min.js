        ...
        return function(t, e, n, i) {
            ...
            var k = function() {
                        ...
                        if ("scroll" === A) {
                            ...
                            for (var _ in P)
                                if ("element" !== _) {
                                    ...
                                    P[_].startValue = P[_].currentValue = P[_].endValue, P[_].endValue = D, m.isEmptyObject(y) || (P[_].easing = s.easing), b.debug && console.log("reverse tweensContainer (" + _ + "): " + JSON.stringify(P[_]), a)
                                }
                            l = P
                        } else if ("start" === A) {
                            var P;
                            ...
                            for (var E in g) {
                                ...
                                var N = w.Hooks.getRoot(E),
                                    z = !1;
                                if (r(a).isSVG || "tween" === N || w.Names.prefixCheck(N)[1] !== !1 || w.Normalizations.registered[N] !== i) {
                                    (s.display !== i && null !== s.display && "none" !== s.display || s.visibility !== i && "hidden" !== s.visibility) && /opacity|filter/.test(E) && !V && 0 !== R && (V = 0), s._cacheValues && P && P[E] ? (V === i && (V = P[E].endValue + P[E].unitType), z = r(a).rootPropertyValueCache[N]) : w.Hooks.registered[E] ? V === i ? (z = w.getPropertyValue(a, N), V = w.getPropertyValue(a, E, z)) : z = w.Hooks.templates[N][1] : V === i && (V = w.getPropertyValue(a, E));
                                    var H, B, Y, j = !1;
                ...
                if (m.isWrapped(this) ? (s = !1, p = 0, f = this, l = this) : (s = !0, p = 1, f = x ? arguments[0].elements || arguments[0].e : arguments[0]), f = a(f)) {
                            ...
                            if (!h.isPlainObject(g) || m.isEmptyObject(g)) {
                                if (m.isString(g) && b.Redirects[g]) {
                                    var _ = h.extend({}, y),
                                        D = _.duration,
                                        E = _.delay || 0;
                                    return _.backwards === !0 && (f = h.extend(!0, [], f).reverse()), h.each(f, function(t, e) {
                                        parseFloat(_.stagger) ? _.delay = E + parseFloat(_.stagger) * t : m.isFunction(_.stagger) && (_.delay = E + _.stagger.call(e, t, C)), _.drag && (_.duration = parseFloat(D) || (/^(callout|transition)/.test(g) ? 1e3 : v), _.duration = Math.max(_.duration * (_.backwards ? 1 - t / C : (t + 1) / C), .75 * _.duration, 200)), b.Redirects[g].call(e, e, _ || {}, t, C, f, I.promise ? I : i)
                                    }), t()
                                }
                    ...
                    var R, _ = h.extend({}, b.defaults, y);
                    if (_.loop = parseInt(_.loop), R = 2 * _.loop - 1, _.loop)
                        for (var W = 0; R > W; W++) {
                            var V = {
                                delay: _.delay,
                                progress: _.progress
                            };
                            W === R - 1 && (V.display = _.display, V.visibility = _.visibility, V.complete = _.complete), k(f, "reverse", V)
                        }
                    return t()
                }
            };
                        ...
                        update: function(t, o, a) {
                            ...
                            if (t) {
                                ...
                                i.each(y.concat(b), function(t) {
                                    if (t.getPadding) {
                                        var e = t.getPadding();
                                        _ = Math.max(_, e.left), D = Math.max(D, e.right)
                                    }
                                ...
                                var V = Math.max(_ - L, 0);
                                L += V, F += Math.max(D - F, 0);
                                var N = Math.max(E - R, 0);
                                R += N, W += Math.max(O - W, 0);
                                var z = a - R - W,
                                    H = o - L - F;
                                H === I && z === A || (i.each(g, function(t) {
                                    t.height = z
                                }), i.each(v, function(t) {
                                    t.height = z
                                }), i.each(y, function(t) {
                                            ...
                                            if ((!(r > 1 && n % r > 0 || n % r == 0 && n + r >= o.ticks.length) || s) && void 0 !== t && null !== t) {
                                                ...
                                                if (m) {
                                                    ...
                                                    var W, V = "left" === a.position,
                                                        N = u.padding;
                                                    u.mirror ? (L = V ? "left" : "right", W = N) : (L = V ? "right" : "left", W = y + N), E = V ? o.right - W : o.left + W;
                                                    var z = o.getPixelForTick(n);
                                                    z += i.aliasPixel(l), O = o.getPixelForTick(n, d.offsetGridLines), v = T, x = M, C = e.left, _ = e.right, b = k = P = D = z
                                                }
                                                S.push({
                                                    tx1: v,
                                                    ty1: b,
...
$(window).scroll(function() {
    ...
    function(t) {
        ...
        }, 700), void 0 !== i && i !== !1 && history.replaceState(null, null, e)
    }),
    function(t) {
...
dropdownSelectors.on({
        ...
        var n = function(e) {
                ...
                if (n.hasClass("active") === !1) {
                    var i = n.hasClass("horizontal"),
                        o = void 0,
                        a = void 0;
                    i === !0 ? a = 40 : o = 40, n.addClass("active"), n.find("ul .btn-floating").velocity({
                        scaleY: ".4",
                        scaleX: ".4",
                        translateY: o + "px",
                        translateX: a + "px"
            ...
            i = function(t) {
                ...
                var e = $this.hasClass("horizontal"),
                    n = void 0,
                    i = void 0;
                e === !0 ? i = 40 : n = 40, $this.removeClass("active");
                $this.find("ul .btn-floating").velocity("stop", !0), $this.find("ul .btn-floating").velocity({
                    opacity: "0",
                    scaleX: ".4",
                    scaleY: ".4",
    ...
    function(t, e, n, i) {
        ...
        function W() {
            this.evEl = zt, this.evWin = Ht, this.pressed = !1, C.apply(this, arguments)
        }
        ...
        c = function() {
            function c(u, d) {
                ...
                t("body").append(v), "left" === d.edge ? (this.menu_id.css("transform", "translateX(-100%)"), v.css({
                    ...
                    window.innerWidth > n ? t("#sidenav-overlay").length ? h.removeMenu(!0) : h.menu_id.css("transform", "translateX(0%)") : p === !1 && ("left" === d.edge ? h.menu_id.css("transform", "translateX(-100%)") : h.menu_id.css("transform", "translateX(100%)"))
                })), this.options.closeOnClick === !0 && this.menu_id.on("click", "a:not(.collapsible-header)", function() {
                    h.removeMenu()
                }), m.click(function(e) {
                    if (e.preventDefault(), p === !0) p = !1, h.removeMenu();
                    else {
                        var n = t("body"),
                            i = t('<div id="sidenav-overlay"></div>');
                        n.append(i), "left" === h.options.edge ? h.menu_id.velocity({
                    ...
                    if ("touch" === e.gesture.pointerType) {
                        ...
                        if ("left" === d.edge && (n > d.MENU_WIDTH ? n = d.MENU_WIDTH : n < 0 && (n = 0)), "left" === d.edge) n < d.MENU_WIDTH / i ? p = !1 : n >= d.MENU_WIDTH / i && (p = !0), h.menu_id.css("transform", "translateX(" + (n - d.MENU_WIDTH) + "px)");
                        else {
                            n < window.innerWidth - d.MENU_WIDTH / i ? p = !0 : n >= window.innerWidth - d.MENU_WIDTH / i && (p = !1);
                            var s = n - d.MENU_WIDTH / i;
                            s < 0 && (s = 0), h.menu_id.css("transform", "translateX(" + s + "px)")
                        }
                        var l = void 0;
                        "left" === d.edge ? (l = n / d.MENU_WIDTH, t("#sidenav-overlay").velocity({
                            opacity: l
                        }, {
                            duration: 10,
                            queue: !1,
                            easing: "easeOutQuad"
                        })) : (l = Math.abs((n - window.innerWidth) / d.MENU_WIDTH), t("#sidenav-overlay").velocity({
                            opacity: l
                        }, {
                            duration: 10,
                            queue: !1,
                    ...
                    if ("touch" === e.gesture.pointerType) {
                        var n = e.gesture.velocityX,
                            ...
                            u = c - d.MENU_WIDTH,
                            f = c - d.MENU_WIDTH / i;
                        u > 0 && (u = 0), f < 0 && (f = 0), "left" === d.edge ? p && n <= o || n < a ? (0 !== u && h.menu_id.velocity({
                            translateX: [0, u]
                        }, {
                            duration: 300,
                            queue: !1,
            ...
            return _createClass(c, [{
                ...
                value: function(e) {
                    ...
                    t("body").css({
                        ...
                        easing: "easeOutCubic",
                        complete: function() {
                            e === !0 && (n.menu_id.removeAttr("style"), n.menu_id.css("width", n.options.MENU_WIDTH))
                        }
...
function(t) {
    var e = this,
        ...
        o = void 0,
        a = function() {
            var n = t('<span class="thumb"><span class="value"></span></span>');
            t(e).after(n)
        };
    t(n).each(a), t(document).on("change", n, function() {
        var n = t(e);
        n.siblings(".thumb").find(".value").html(n.val())
    }), t(document).on("input mousedown touchstart", n, function(n) {
        var r = t(e),
            s = r.siblings(".thumb"),
            l = r.outerWidth();
        (!s.length && a(), s.find(".value").html(r.val()), i = !0, r.addClass("active"), s.hasClass("active") || s.velocity({
            height: "30px",
            width: "30px",
            top: "-20px",
            marginLeft: "-15px"
            ...
            duration: 300,
            easing: "easeOutExpo"
        }), "input" !== n.type) && (o = void 0 === n.pageX || null === n.pageX ? n.originalEvent.touches[0].pageX - t(e).offset().left : n.pageX - t(e).offset().left, o < 0 ? o = 0 : o > l && (o = l), s.addClass("active").css("left", o));
        s.find(".value").html(r.val())
    }), t(document).on("mouseup touchend", ".range-field", function() {
        i = !1, t(e).removeClass("active")
        ...
        if (i) {
            ...
            a = void 0 === e.pageX || null === e.pageX ? e.originalEvent.touches[0].pageX - t(this).offset().left : e.pageX - t(this).offset().left;
            var r = t(this).outerWidth();
            a < 0 ? a = 0 : a > r && (a = r), o.addClass("active").css("left", a), o.find(".value").html(o.siblings(n).val())
        }
    }), t(document).on("mouseout touchleave", ".range-field", function() {
        if (!i) {
            var n = t(e).children(".thumb");
...
function(t) {
    ...
    function() {
        ...
        function i(i, r) {
            ...
            if (d.on(h, function(t) {
                ...
                var N = t("g");
                N.setAttribute("transform", "translate(" + v + "," + v + ")");
                var z = t("circle");
                ...
                var Y = t("circle");
                Y.setAttribute("class", "clockpicker-canvas-fg"), Y.setAttribute("r", 5), N.appendChild(H), N.appendChild(B), N.appendChild(Y), N.appendChild(z), V.appendChild(N), W.append(V), this.hand = H, this.bg = B, this.fg = Y, this.bearing = z, this.g = N, this.canvas = W
            }
            o(this.options.init)
        }
    ...
    function(t, e) {
        ...
        return function(t, e, n, i) {
            ...
            o.extend(r, i);
            var s, l, c, u, d, h, p, f, m, g, v, y, b, x, w, k, C, S, T, M, I, A, P, _, D, E, O, L, F, R, W, V, N, z, H, B, Y, j, $, X, q, U, Q, Z, G, K, J, tt, et, nt, it, ot, at, rt, st, lt, ct = function() {
                    return {
                        x: 0,
                        y: 0
                    }
                ...
                $t = function() {
                    if (A) {
                        return y = "translate" + (W.perspective && !_ ? "3d(" : "("), void(b = W.perspective ? ", 0px)" : ")")
                    }
                ...
                ee = {
                    ...
                    init: function() {
                        if (!s && !l) {
                            ...
                            var c = "pswp--open ";
                            for (r.mainClass && (c += r.mainClass + " "), r.showHideOpacity && (c += "pswp--animate_opacity "), c += _ ? "pswp--touch" : "pswp--notouch", c += W.animationName ? " pswp--css_animation" : "", c += W.svg ? " pswp--svg" : "", o.addClass(t, c), a.updateSize(), h = -1, vt = null, n = 0; 3 > n; n++) Et((n + h) * gt.x, k[n].el.style);
                            F || o.bind(a.scrollWrap, f, a), Tt("initialZoomInEnd", function() {
                                a.setContent(k[0], u - 1), a.setContent(k[2], u + 1), k[0].el.style.display = k[2].el.style.display = "block", r.focus && t.focus(), Nt()
                    ...
                    close: function() {
                        s && (s = !1, l = !0, Mt("close"), zt(), Ge(a.currItem, null, !0, a.destroy))
                    },
                    destroy: function() {
                    ...
                    panTo: function(t, e, n) {
                        n || (t > tt.min.x ? t = tt.min.x : t < tt.max.x && (t = tt.max.x), e > tt.min.y ? e = tt.min.y : e < tt.max.y && (e = tt.max.y)), ht.x = t, ht.y = e, _t()
                    },
                    handleEvent: function(t) {
                    ...
                    updateCurrItem: function(t) {
                        if (0 !== vt) {
                            ...
                            if (!(t && 2 > n)) {
                                ...
                                if (et && 1 === Math.abs(vt)) {
                                    var o = Ue(C);
                                    o.initialZoomLevel !== g && (on(o, pt), ln(o), Dt(o))
                                }
                    ...
                    updateSize: function(e) {
                        ...
                        if (pt.x = a.scrollWrap.clientWidth, pt.y = a.scrollWrap.clientHeight, Ut(), gt.x = pt.x + Math.round(pt.x * r.spacing), gt.y = pt.y, Ot(gt.x * ft), Mt("beforeResize"), void 0 !== h) {
                            for (var i, s, l, c = 0; 3 > c; c++) i = k[c], Et((c + h) * gt.x, i.el.style), l = u + c - 1, r.loop && Qe() > 2 && (l = Ct(l)), s = Ue(l), s && (w || s.needsUpdate || !s.bounds) ? (a.cleanSlide(s), a.setContent(i, l), 1 === c && (a.currItem = s, a.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === i.index && l >= 0 && a.setContent(i, l), s && s.container && (on(s, pt), ln(s), Dt(s));
                            w = !1
                        }
                        v = g = a.currItem.initialZoomLevel, tt = a.currItem.bounds, tt && (ht.x = tt.center.x, ht.y = tt.center.y, _t(!0)), Mt("resize")
                    },
                    zoomTo: function(t, e, n, i, a) {
                        ...
                        Rt(s);
                        var u = function(e) {
                            1 === e ? (g = t, ht.x = s.x, ht.y = s.y) : (g = (t - l) * e + l, ht.x = (s.x - c.x) * e + c.x, ht.y = (s.y - c.y) * e + c.y), a && a(e), _t(1 === e)
                        };
                ...
                Oe = function(t) {
                    ...
                    })) : t.type.indexOf("touch") > -1 ? t.touches && t.touches.length > 0 && (Ee[0] = Me(t.touches[0], _e), t.touches.length > 1 && (Ee[1] = Me(t.touches[1], De))) : (_e.x = t.pageX, _e.y = t.pageY, _e.id = "", Ee[0] = _e), Ee
                },
                Le = function(t, e) {
                    ...
                    if (!("mousedown" === t.type && t.button > 0)) {
                        ...
                        if (!Y || "mousedown" !== t.type) {
                            ...
                            Z = null, Jt(), j && 1 !== i || (j = ot = !0, o.bind(window, p, a), H = st = at = B = Q = q = $ = X = !1, it = null, Mt("firstTouchStart", n), Ft(dt, ht), ut.x = ut.y = 0, Ft(ae, n[0]), Ft(re, ae), le.x = gt.x * ft, ce = [{
                                x: ae.x,
                                y: ae.y
                            }], N = V = It(), Ht(g, !0), xe(), we()), !G && i > 1 && !nt && !Q && (v = g, X = !1, G = $ = !0, ut.y = ut.x = 0, Ft(dt, ht), Ft(ne, n[0]), Ft(ie, n[1]), Ie(ne, ie, ge), me.x = Math.abs(ge.x) - ht.x, me.y = Math.abs(ge.y) - ht.y, K = J = be(ne, ie))
                        }
                    }
                },
                Re = function(t) {
                    ...
                    if (Z) {
                        ...
                        if (0 !== t)
                            if (Ft(ne, Z[0]), oe.x = ne.x - ae.x, oe.y = ne.y - ae.y, G && t > 1) {
                                ...
                                0 > i && (i = 0), K = e, Ie(ne, ie, he), ut.x += he.x - ge.x, ut.y += he.y - ge.y, Ft(ge, he), ht.x = Lt("x", n), ht.y = Lt("y", n), H = n > g, g = n, _t()
                            } else {
                                if (!it) return;
                                ...
                                if ("v" === it && r.closeOnVerticalDrag && !ke()) {
                                    ut.y += oe.y, ht.y += oe.y;
                                    var u = Pe();
                                    return B = !0, Mt("onVerticalDrag", u), At(u), void _t()
                                }
                ...
                Ve = function(t) {
                    ...
                    if (0 === c && (j = !1, o.unbind(window, p, a), xe(), G ? u = 0 : -1 !== pe && (u = It() - pe)), pe = 1 === c ? It() : -1, s = -1 !== u && 150 > u ? "zoom" : "swipe", G && 2 > c && (G = !1, 1 === c && (s = "zoomPointerUp"), Mt("zoomGestureEnded")), Z = null, q || X || nt || B)
                        if (Jt(), z || (z = Ne()), z.calculateSwipeSpeed("x"), B) {
                            var d = Pe();
                            if (d < r.verticalDragRange) a.close();
                                ...
                                te("verticalDrag", 0, 1, 300, o.easing.cubic.out, function(t) {
                                    ht.y = (a.currItem.initialPosition.y - h) * t + h, At((1 - f) * t + f), _t()
                                }), Mt("onVerticalDrag", 1)
                            }
                        } else {
                            if ((Q || nt) && 0 === c) {
                            ...
                            if (!nt) return "swipe" !== s ? void Ye() : void(!Q && g > a.currItem.fitRatio && ze(z))
                        }
                },
                Ne = function() {
                    var t, e, n = {
                        ...
                        calculateSwipeSpeed: function(i) {
                            ce.length > 1 ? (t = It() - N + 50, e = ce[ce.length - 2][i]) : (t = It() - V, e = re[i]), n.lastFlickOffset[i] = ae[i] - e, n.lastFlickDist[i] = Math.abs(n.lastFlickOffset[i]), n.lastFlickDist[i] > 20 ? n.lastFlickSpeed[i] = n.lastFlickOffset[i] / t : n.lastFlickSpeed[i] = 0, Math.abs(n.lastFlickSpeed[i]) < .1 && (n.lastFlickSpeed[i] = 0), n.slowDownRatio[i] = .95, n.slowDownRatioReverse[i] = 1 - n.slowDownRatio[i], n.speedDecelerationRatio[i] = 1
                        },
                        ...
                        panAnimLoop: function() {
                            return Qt.zoomPan && (Qt.zoomPan.raf = D(n.panAnimLoop), n.now = It(), n.timeDiff = n.now - n.lastNow, n.lastNow = n.now, n.calculateAnimOffset("x"), n.calculateAnimOffset("y"), _t(), n.calculateOverBoundsAnimOffset("x"), n.calculateOverBoundsAnimOffset("y"), n.speedDecelerationRatioAbs.x < .05 && n.speedDecelerationRatioAbs.y < .05) ? (ht.x = Math.round(ht.x), ht.y = Math.round(ht.y), _t(), void Gt("zoomPan")) : void 0
                        }
                    };
                    return n
                },
            ...
            kt("Gestures", {
                publicMethods: {
                    initGestures: function() {
                        ...
                        P = W.pointerEvent, P && W.touch && (W.touch = !1), P ? navigator.pointerEnabled ? t("pointer", "down", "move", "up", "cancel") : t("MSPointer", "Down", "Move", "Up", "Cancel") : W.touch ? (t("touch", "start", "move", "end", "cancel"), _ = !0) : t("mouse", "down", "move", "up"), p = T + " " + M + " " + I, f = S, P && !_ && (_ = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1), a.likelyTouchDevice = _, m[S] = Fe, m[T] = Re, m[M] = Ve, I && (m[I] = m[M]), W.touch && (f += " mousedown", p += " mousemove mouseup", m.mousedown = m[S], m.mousemove = m[T], m.mouseup = m[M]), _ || (r.allowPanToNext = !1)
                    }
                }
            });
            var je, $e, Xe, qe, Ue, Qe, Ze, Ge = function(e, n, i, s) {
                    ...
                    if (!d || !l || void 0 === l.x) return Mt("initialZoom" + (i ? "Out" : "In")), g = e.initialZoomLevel, Ft(ht, e.initialPosition), _t(), t.style.opacity = i ? 0 : 1, At(1), void(d ? setTimeout(function() {
                        h()
                    }, d) : h());
                    ! function() {
                        var n = c,
                            s = !a.currItem.src || a.currItem.loadError || r.showHideOpacity;
                        e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), i || (g = l.w / e.w, ht.x = l.x, ht.y = l.y - L, a[s ? "template" : "bg"].style.opacity = .001, _t()), Kt("initialZoom"), i && !n && o.removeClass(t, "pswp--animated-in"), s && (i ? o[(n ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function() {
                            ...
                            if (Mt("initialZoom" + (i ? "Out" : "In")), i) {
                                var a = l.w / e.w,
                                    ...
                                    u = rt,
                                    p = function(e) {
                                        1 === e ? (g = a, ht.x = l.x, ht.y = l.y - R) : (g = (a - c) * e + c, ht.x = (l.x - r.x) * e + r.x, ht.y = (l.y - R - r.y) * e + r.y), _t(), s ? t.style.opacity = 1 - e : At(u - e * u)
                                    };
                                n ? te("initialZoom", 0, 1, d, o.easing.cubic.out, p, h) : (p(1), je = setTimeout(h, d + 20))
                            } else g = e.initialZoomLevel, Ft(ht, e.initialPosition), _t(), At(1), s ? t.style.opacity = 1 : At(1), je = setTimeout(h, d + 20)
                        }, i ? 25 : 90)
                    }()
                },
                Ke = {},
                    ...
                    setContent: function(t, e) {
                        ...
                        if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), sn(l), on(l, pt), !l.src || l.loadError || l.loaded) l.src && !l.loadError && (i = o.createEl("pswp__img", "img"), i.style.opacity = 1, i.src = l.src, ln(l, i), an(0, l, c, i));
                            ...
                            if (l.loadComplete = function(n) {
                                    if (s) {
                                        if (t && t.index === e) {
                                            if (sn(n, !0)) return n.loadComplete = n.img = null, on(n, pt), Dt(n), void(t.index === u && a.updateCurrZoomItem());
                        ...
                        Xe || e !== u ? Dt(l) : (et = c.style, Ge(l, i || l.img)), t.el.innerHTML = "", t.el.appendChild(c)
                    },
            ...
            var fn, mn, gn, vn, yn, bn, xn, wn, kn, Cn, Sn, Tn, Mn = {
                ...
                _n = function() {
                    if (gn && clearTimeout(gn), Zt || j) return void(gn = setTimeout(_n, 500));
            ...
            kt("History", {
                publicMethods: {
                    ...
                    updateURL: function() {
                        An(), yn || (wn ? fn = setTimeout(_n, 800) : _n())
                    }
                }
            }), o.extend(a, ee)
        }
    ...
    function(t, e) {
        ...
        return function(t, e) {
            ...
            w.init = function() {
                ...
                }), d("parseVerticalMargin", H), $(), g.shareEl && s && l && (S = !0), P(), B(), V(), N()
            ...
            return this.$el = t(this), this.$document = t(document), this.SELS = {
                ...
                o.$document.on("click", e.CHIPS, function(n) {
                    ...
                    if (!t(n.target).is("input, textarea")) {
                        var i = o.$document.find(e.CHIP + e.SELECTED_CHIP),
                            a = i.closest(e.CHIPS),
                            r = i.siblings(e.CHIP).length,
                            s = void 0;
                        if (i.length) {
                            ...
                            if (l) {
                                ...
                                if (s = i.index() + 1, t(e.CHIP).removeClass("selected"), s > r) return void a.find("input").focus();
                ...
                i && i.hasClass("selected") === !1 && (i.addClass("selected"), n.trigger("chip.select", n.data("chips")[e]))
    ...
    function() {
        ...
        return t = $.extend(e, t), this.each(function() {
            ...
            e.on("keyup", function(t) {
                ...
                13 == t.which && (i.children(":first").trigger("click"), i.empty()), 0 == o.length ? $(this).parent().find(".mdb-autocomplete-clear").css("visibility", "hidden") : $(this).parent().find(".mdb-autocomplete-clear").css("visibility", "visible")
            }), i.on("click", "li", function() {
                e.val($(this).text()), i.empty()
            }), $(".mdb-autocomplete-clear").on("click", function(t) {
                t.preventDefault(), $(this).parent().find("input").val(""), $(this).css("visibility", "hidden"), $(this).parent().find(".mdb-autocomplete-wrap").empty(), $(this).parent().find("label").removeClass("active")
            })
        })
